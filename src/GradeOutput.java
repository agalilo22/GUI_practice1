...
public class GradeOutput extends JFrame {
    ...
    public JLabel lblStudentName, lblStudentNo, lblQuiz1, lblQuiz2, lblQuiz3, lblAveGrade;
    public JTextField txtStudentName, txtStudentNo, txtQuiz1, txtQuiz2, txtQuiz3, txtAveGrade;
    public JButton closeButton;

    public GradeOutput (Student stud) {
        // Set up the frame
        JFrame frame = new JFrame("Grade Output");
        setSize(450, 250);
        stud.computeAverage();
